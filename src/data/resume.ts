    ...
    projects: [
      {
        ...
        points: [
          ...
          '구글 태그 매니저와 구글 애널리틱스로 사용자 행동을 추적하고 데이터를 기반으로 서비스 개선 및 마케팅 전략 수립에 활용했습니다.',
          '구글 서치콘솔 기준 최근 30일 클릭 수 1.7천 회(+41.8%), 노출 수 1.5만 회, 평균 CTR 11.3% / 네이버 서치어드바이저 기준 활성 사용자 2.4천 명(+61.1%), 이벤트 수 2.9만 건(+50.8%)을 달성했습니다.',
